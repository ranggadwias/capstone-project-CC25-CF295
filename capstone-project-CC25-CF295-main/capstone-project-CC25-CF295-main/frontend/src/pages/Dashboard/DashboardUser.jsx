...
function DashboardUser() {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, height: { md: "100vh" }, overflow: { md: "hidden" } }}>
      <Sidebar />

      <Box sx={{ flexGrow: 1, ml: { md: "30px", xs: 0 }, p: 3, overflowY: "auto", minHeight: "100vh" }}>
        ...
        <Grid container spacing={2} direction={{ xs: "column", md: "row" }}>
          <Grid item xs={12} md={4}>
            <Card sx={{ textAlign: "center", p: 2, height: "100%", mb: { xs: 2, md: 0 } }}>
